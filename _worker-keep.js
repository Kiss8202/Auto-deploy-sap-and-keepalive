// 环境变量配置(必填)
let email = "windows158@gmail.com";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "@Xc2812829";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD
...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://sgkwxels.cfapps.ap21.hana.ondemand.com", name: "sgkwxels"},  
  {url: "https://usjcgekj.cfapps.us10-001.hana.ondemand.com", name: "usjcgekj"}
];
